...
CUSTOM_FIELDS = {
	...
	"Warehouse": [
		...
		{
			"fieldname": "ch_hub_bin_type",
			"label": _("Hub Bin Label"),
			"fieldtype": "Data",
			"insert_after": "ch_bin_type",
			"in_standard_filter": 1,
			"depends_on": "eval:doc.ch_location_type=='Hub Bin'",
			"description": _("Free-form sub-bin label for hub warehouses (e.g. Sellable-01, Sellable-02, Quarantine). Unique within a hub."),
		},
		{
			"fieldname": "ch_store",
			"label": _("CH Store"),
	...
	"Item": [
		...
		{
			"fieldname": "ch_default_warranty_type",
			"label": _("Default Warranty Type"),
			"fieldtype": "Select",
			"options": "\nManufacturer\nSeller",
			"default": "Manufacturer",
			"insert_after": "ch_warranty_section",
			"description": _("Who backs the out-of-the-box warranty on this device — the brand (Manufacturer) or GoGizmo (Seller)."),
		},
		{
			"fieldname": "ch_default_warranty_months",
			"label": _("Default Warranty Duration"),
			"fieldtype": "Int",
			"insert_after": "ch_default_warranty_type",
			"description": _("Duration of the default warranty, in the unit selected alongside. Stamped on every device of this item at sale."),
		},
		{
			"fieldname": "ch_default_warranty_uom",
