...
CUSTOMER_CUSTOM_FIELDS = {
	"Customer": [
		...
		# ── Customer Photo ──
		{
			"fieldname": "ch_photo_section",
			"label": _("Customer Photo"),
			"fieldtype": "Section Break",
			"insert_after": "ch_kyc_tab",
		},
		{
			"fieldname": "ch_customer_photo",
			"label": _("Customer Photo"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_photo_section",
			"description": _("Live photo of the customer taken during buyback / service"),
		},
		{
			"fieldname": "ch_photo_col_1",
			"fieldtype": "Column Break",
			"insert_after": "ch_customer_photo",
		},
		{
			"fieldname": "ch_customer_photo_source",
			"label": _("Photo Source"),
			"fieldtype": "Data",
			"insert_after": "ch_photo_col_1",
			"read_only": 1,
			"description": _("DocType and name of the transaction where photo was captured"),
		},
		# ── Identity Documents ──
		{
			...
			"fieldtype": "Section Break",
			"insert_after": "ch_customer_photo_source",
		},
		{
			"fieldname": "ch_id_type",
		...
		{
			"fieldname": "ch_id_number",
			"label": _("ID Number"),
			"fieldtype": "Data",
			"insert_after": "ch_id_type",
		},
		{
			"fieldname": "ch_aadhaar_number",
			"label": _("Aadhaar Number"),
			"fieldtype": "Data",
			"insert_after": "ch_id_number",
			"description": _("12-digit Aadhaar number (masked in display)"),
		},
		{
			"fieldname": "ch_id_col_1",
			"fieldtype": "Column Break",
			"insert_after": "ch_aadhaar_number",
		},
		{
			"fieldname": "ch_id_front_image",
			"label": _("ID Front Image"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_id_col_1",
		},
		{
			"fieldname": "ch_id_back_image",
			"label": _("ID Back Image"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_id_front_image",
		},
		{
			"fieldname": "ch_aadhaar_document",
			"label": _("Aadhaar Document"),
			"fieldtype": "Attach",
			"insert_after": "ch_id_back_image",
			"description": _("Legacy field — use ID Front/Back images for new records"),
		},
		# ── KYC Verification Status ──
		{
			"fieldname": "ch_kyc_status_section",
			"label": _("KYC Verification Status"),
			"fieldtype": "Section Break",
		...
		},
		{
			...
			"fieldtype": "Check",
			"insert_after": "ch_kyc_status_section",
			"default": "0",
		},
		{
		...
		{
			"fieldname": "ch_kyc_source_order",
			"label": _("KYC Source Order"),
			"fieldtype": "Data",
			"insert_after": "ch_kyc_col_1",
			"read_only": 1,
			"description": _("Buyback Order from which KYC was captured"),
		},
		{
			"fieldname": "ch_total_kyc_verifications",
			"label": _("Total KYC Verifications"),
			"fieldtype": "Int",
			"insert_after": "ch_kyc_source_order",
			"read_only": 1,
			"default": "0",
		},
		# ── Device / Phone Photos ──
		{
			"fieldname": "ch_device_photos_section",
			"label": _("Last Device Photos"),
			"fieldtype": "Section Break",
			"insert_after": "ch_total_kyc_verifications",
			"collapsible": 1,
			"description": _("Photos from the most recent buyback transaction"),
		},
		{
			"fieldname": "ch_device_photo_front",
			"label": _("Device Front"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_device_photos_section",
		},
		{
			"fieldname": "ch_device_photo_back",
			"label": _("Device Back"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_device_photo_front",
		},
		{
			"fieldname": "ch_device_photo_col_1",
			"fieldtype": "Column Break",
			"insert_after": "ch_device_photo_back",
		},
		{
			"fieldname": "ch_device_photo_screen",
			"label": _("Device Screen"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_device_photo_col_1",
		},
		{
			"fieldname": "ch_device_photo_imei",
			"label": _("IMEI / Serial Photo"),
			"fieldtype": "Attach Image",
			"insert_after": "ch_device_photo_screen",
		},
		{
			"fieldname": "ch_device_photo_source",
			"label": _("Photo Source"),
			"fieldtype": "Data",
			"insert_after": "ch_device_photo_imei",
			"read_only": 1,
		},
		# ══════════════════════════════════════════════
